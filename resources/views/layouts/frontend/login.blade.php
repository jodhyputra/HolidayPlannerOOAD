	...
	<!-- this is the entire modal form, including the background -->
	    <div class="cd-signin-modals js-signin-modal"> <!-- this is the entire modal form, including the background -->
                                <div class="cd-signin-modal__container "> <!-- this is the container wrapper -->
                                    ...
                                    <div class="cd-signin-modal__blocks js-signin-modal-block js-signin-modal-switcher js-signin-modal-trigger" data-type="login"> <!-- log in form -->
                                        <form class="cd-signin-modal__forms" action ="/login/process" method="POST" enctype="application/x-www-form-urlencoded">
                                            @csrf
                                    ...
                                    <div class="cd-signin-modal__block js-signin-modal-block" data-type="reset"> <!-- reset password form -->
                                        ...
                                        <form class="cd-signin-modal__form" action="" method="POST">
                                            <p class="cd-signin-modal__fieldset">
                                                ...
                                                <input class="cd-signin-modal__input cd-signin-modal__input--full-width cd-signin-modal__input--has-padding cd-signin-modal__input--has-border" name="email" id="reset-email" type="email" placeholder="E-mail">
                                                <span class="cd-signin-modal__error">Error message here!</span>
                                            </p>

                                            <p class="cd-signin-modal__fieldset">
                                                <input class="cd-signin-modal__input cd-signin-modal__input--full-width cd-signin-modal__input--has-padding" type="submit" value="Reset password" name="password">
                                            </p>
                                        </form>
